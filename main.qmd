...
author:
  - name: Liudmila Pishchagina
    ...
    affiliations:
      - name: Université Paris-Saclay, CNRS, Université d'Évry-Val-d'Essonne, Laboratoire de Mathématiques et Modélisation d'Évry, France
  - name: Guillem Rigaill
    email: guillem.rigaill@inrae.fr    
    orcid: 0000-0002-7176-7511
    affiliations:
      - name: Université Paris-Saclay, CNRS, Université d'Évry-Val-d'Essonne, Laboratoire de Mathématiques et Modélisation d'Évry, France
      - name: Université Paris-Saclay, CNRS, INRAE, Université d'Évry-Val-d'Essonne, Institute of Plant Sciences Paris-Saclay (IPS2), Orsay, France
  - name: Vincent Runge
...
We define a cost function for segmentation as in equation ([@eq-Cy_it-]) by the function $\Omega(\cdot,\cdot)$ (the opposite log-likelihood (times two)). Below is the expression of this function  linked to data point $y_i = (y_i^1,\dots, y_i^p)$ in $\mathbb R^p$ for three examples of parametric multivariate models:
